...
const functions = {
    ...
    relative_url: { description: 'Returns a relative URL from the absolute input URL. The absolute input URL must begin with `/`, `http://` or `https://`, otherwise an error is thrown.' },
